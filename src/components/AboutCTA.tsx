    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-[#3d75ef] to-[#5d8fff]">
      <div className="max-w-4xl mx-auto text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <button className="bg-transparent border-2 border-white text-white px-10 py-5 rounded-xl font-bold text-lg hover:bg-white hover:text-[#3d75ef] transition-all hover:shadow-2xl hover:scale-105">
